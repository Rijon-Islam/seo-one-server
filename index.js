...
const uri = "mongodb+srv://infogettinginformationdone:7LQ41ZgINc3ZUVsL@cluster0.0xjjitn.mongodb.net/?retryWrites=true&w=majority";
...
app.listen(port, () => {
    console.log('Good Job, SEO Server is Live Now', port);
});